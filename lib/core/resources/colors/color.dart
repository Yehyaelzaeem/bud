...
const googleColor =  Color(0xffF14436);
...
const Color tableBackGround = Color(0xFFE7EDF6);
const canvasColor = Color(0xFF2E2E48);
const customYellow = Color(0xFFFFBC5B);
...
const textSelectionDark = Colors.grey;
 ...
 const Color  backGroundPink= Color(0xffFEE5E3);
 const Color  backGroundPink2= Color(0xffFAEDF0);
 const Color  backGroundPink3= Color(0xffFE8270);
 const Color  customWhite= Color(0xffF9F9FF);
 const Color  customBluColor=  Color(0xffA7D7F2);
 const Color  textPink=  Color(0xffFE9F91);
 ...
 // const Color  primaryColor= Color(0xff71C0A3);
 // const Color  primaryColorLight= Color(0xffFE8270);
 // const primaryColorDark =Color(0xffFEC641);
 // const cardColor = Color(0xFFFFFFFF);
 // const hoverColor = Color(0xFFE4E6E8);

  Color  customBlue= Colors.blue.shade300;
 const Color  customGreen= Color(0xff20B857);
 const Color  black= Color(0xff000000);
 const Color  gray2= Color(0xff818181);
 const Color  desColor= Color(0xff4C5756);
 const Color  redColor= Color(0xffEB003B);
 const Color  grayBorderColor= Color(0xffD0D5DD);
 const Color  grayBackGroundColor= Color(0xffF6F6F6);
 const Color  starColor= Color(0xffE4A951);


 const Color kAppBarColor = Color(0xffFDF2E9);
 ...
 const Color brownColor =Color(0xffB0A988);
 const Color bagColor =Color(0xffEAE3C4);
 const Color highGreyColor =Color(0xff818181);
 const Color carCheckColor =Color(0xffB8A99AB2);
 const Color carCheckColor2 =Color(0xffFFC98B);
 const Color tireColor1 =Color.fromRGBO(71, 159, 144, 0.70);
